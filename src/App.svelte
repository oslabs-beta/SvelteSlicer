    ...
    <div id="snapshots">
      {#if !filtered.length}
        {#each $snapshots as snapshot, i}
          <div
            ...
            class:inactiveSnapshot={!timeline[CurrentAppView].includes(i)}
          >
            ...
            <div class="snapshotButtonGroup">
              <button
                ...
                class:selectedButton={i === CurrentI}>Data</button
              >
              <button class="snapshotButton" on:click={() => jumpState(i)}
                >Jump</button
              >
            </div>
          </div>
      ...
      {:else if filtered.length}
        {#each filtered as snapshot}
          <div
            class="snapshotList"
            class:selectedSnapshot={snapshot.index === CurrentAppView}
            class:inactiveSnapshot={!timeline[CurrentAppView].includes(
              snapshot.index
            )}
          >
            <span class="snapshotText"
            ...
            <div class="snapshotButtonGroup">
              <button
                ...
                class:selectedButton={snapshot.index === CurrentI}>Data</button
              >
              <button
                class="snapshotButton"
                on:click={() => jumpState(snapshot.index)}>Jump</button
              >
            </div>
          </div>
        {/each}
      ...
      <div id="clearButtons" class="tooltip">
        ...
        <div class="toolTipPath">
          ...
          <span class="toolTipPathText"
            >Remove Snapshots outside current view's timeline</span
          >
        </div>
        <div class="toolTipFwd">
          ...
          <span class="toolTipFwdText"
            >Remove all Snapshots after the current view</span
          >
        </div>
      </div>
    </div>
